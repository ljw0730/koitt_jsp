...
<body>
	...
	<section>
		...
		<table>
			...
			<tr>
				<th colspan="3"><strong>${content_view.getbTitle() }</strong></th>
			</tr>
			<tr>
				<th colspan="3"><strong>${content_view.getbId() }</strong></th>
			</tr>
			<tr>
		...
		<!-- <a href="delete.do?bId=${content_view.getbId() }"><div class="list">삭제</div></a>  -->
		<a href="#" onclick="delete_check()"><div class="list">삭제</div></a>
		<a href="modify_view.do?bId=${content_view.getbId() }"><div class="list">수정</div></a>
		<a href="reply_view.do?bId=${content_view.getbId() }"><div class="list">답글</div></a>
	</section>
