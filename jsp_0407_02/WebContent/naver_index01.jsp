	...
	<body>
			...
			if(cookies == null) {
				...
				for(int i = 0; i < cookies.length; i++) {
					...
					if(cookie_ch.equals("auth_User")) {
						auth_User = cookies[i].getValue(); // id: admin 저장
						break;
					}
					else {
						auth_User = null;
		...
		%>
				...
				<div id="section_login">
					...
					<a id="login_btn" href="login.html">NAVER 로그인</a>
					<div id="lg_link">
		...
		%>
				<!-- 로그인 되었을 때  -->
				<div id="user_info">
					<strong><a href="#"><%= auth_User %> 님</a></strong>
					<a href="logout.jsp" id="logout_btn"> 로그 아웃</a>
				</div>
