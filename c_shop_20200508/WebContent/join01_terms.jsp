...
<link rel="stylesheet" href="css/style_join01_terms.css">
<script type="text/javascript" src="js/script_join01_terms.js"></script>
</head>
<body>
	<header>
		<ul>
	...
	<section>
			<form id="agree_form" name="agree" method="get" action="join02_info_input.doj">
				...
				<h4>
					이용약관 동의 
					<span>(필수동의)</span>
					<a id="f_greebox_full" href="">전체보기</a>
				</h4>
				<div class="agreebox">
					<article>
						<div id="f_agreebox">
