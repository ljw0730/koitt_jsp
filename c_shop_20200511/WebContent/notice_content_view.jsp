...
<body>
	...
	<section>
		...
		<table>
			...
			<tr>
				<th colspan="3"><strong>${content_view.getbId() } - ${content_view.getbTitle() }</strong></th>
			</tr>
			<tr>
				<td></td>
				<td>작성자</td>
			...
			<tr>
				<td>${content_view.getbDate() }</td>
				<td>조회수</td>
				<td>${content_view.getbHit() }</td>
			</tr>
			<tr>
				<td colspan="3" class="article">${content_view.getbContent() }</td>
			</tr>
			<tr>
				<td colspan="3"><strong>다음글</strong> <span class="separator">|</span>
					<a href="#">[키즈잼] 2월 프로그램 안내</a></td>
			</tr>
			<tr>
				<td colspan="3"><strong>이전글</strong> <span class="separator">|</span>
					<a href="#">[키즈잼] 2020년 1분기 정기 휴관일 안내</a></td>
			</tr>
		</table>

		
		<a href="notice_list.do"><div class="list">목록</div></a>
		<a href="#" onclick="dalete_check('${content_view.getbId() }')"><div class="list">삭제</div></a>
		<a href="notice_modify_view.do?bId=${content_view.getbId() }"><div class="list">수정</div></a>
		<a href="notice_reply_view.do?bId=${content_view.getbId() }"><div class="list">답글</div></a>
	</section>
