...
<body>
	...
	<section>
		...
		<form action="event_write.doe" name="ewrite" method="post" enctype="Multipart/form-data">
			<table>
				<colgroup>
					<col width="15%">
					<col width="85%">
				...
				<tr>
					<th>내용</th>
					<td><textarea name="eContent" cols="50" rows="10"></textarea></td>
				</tr>
				<tr>
					<th>시작 일</th>
					<td><input type="date" name="eStartdate" id="eStartdate" /> </td>
				</tr>
				<tr>
					<th>종료 일</th>
					<td><input type="date" name="eEnddate" id="eEnddate" /> </td>
				</tr>
				<tr>
					<th>event화면 이미지</th>
					<td><input type="file" name="eTitleimg" id="eTitleimg"></td>
				</tr>
				<tr>
					<th>event 상세 화면 이미지</th>
					<td><input type="file" name="eContentimg" id="eContentimg"></td>
				</tr>
			</table>
			<hr>
			<div class="button-wrapper">
				<button type="button" class="write" onclick="event_write_check()">작성완료</button>
