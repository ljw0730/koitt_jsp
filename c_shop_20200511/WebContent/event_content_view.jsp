...
<body>
    ...
    <table>
      ...
      <tr>
        <td>${ebdto.eStartdate } ~ ${ebdto.eEnddate }</td>
      </tr>
      <tr>
        <td class="article">
          ${ebdto.eContent } <br/>
          <img src="upload/${ebdto.eContentimg }" alt="${ebdto.eContentimg }" width="80%">
          </td>
      </tr>
      <tr>
        <td><strong>다음글</strong> <span class="separator">|</span><a href="#">착한 팩트 event</a></td>
      </tr>
      <tr>
        <td><strong>이전글</strong> <span class="separator">|</span><a href="#">해피 발렌타인데이</a></td>
      </tr>
    </table>

    <a href="event_list.doe"><div class="list">목록</div></a>
    <a href="#" onclick="event_delete_check('${ebdto.eId}')"><div class="list">삭제</div></a>
    <a href="evenvt_modify_view.doe?eId=${ebdto.eId}"><div class="list">수정</div></a>
  </section>
