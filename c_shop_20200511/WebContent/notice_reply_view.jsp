...
<body>
	...
	<section>
		...
		<form action="notice_reply.do" name="reply" method="post">
			<table>
			<input type="hidden" name="bId" value="${reply_view.getbId() }" />
			<input type="hidden" name="bGroup" value="${reply_view.getbGroup() }" />
			<input type="hidden" name="bStep" value="${reply_view.getbStep() }" />
			<input type="hidden" name="bIndent" value="${reply_view.getbIndent() }" />			
				<colgroup>
					<col width="15%">
					<col width="85%">
				</colgroup>
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="bTitle" value="[답글]"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td>
						<textarea name="bContent" cols="50" rows="10">
						${reply_view.getbContent() }
						------------------------------------------
						[답글]
						</textarea>
					</td>
			...
			<div class="button-wrapper">
				<button type="button" class="write" onclick="reply_check()">답글완료</button>
