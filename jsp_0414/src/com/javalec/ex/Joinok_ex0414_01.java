...
public class Joinok_ex0414_01 extends HttpServlet {
	...
	protected void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql1 = "select id from member2 where id='" + id + "'";
		//String sql2 = "insert into member2 values ('ccc', '1234', '김유신', '010', '3333', '3333', '남자')";
		String sql2 = "insert into member2 values ('" + id + "', '" + pw + "', '" + name + "', '" 
		...
		try {
			...
			if(rs.next()) {
				...
				do {
					...
					writer.println("</head>");
					writer.println("<body>");
					writer.println("<script>alert('이미 있는 아이디 입니다. 아이디를 다시 입력해 주세요.');");
